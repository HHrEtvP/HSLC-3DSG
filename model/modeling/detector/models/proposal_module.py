...
from model.modeling.detector.pointnet2.pointnet2_modules import PointnetSAModuleVotes
import model.modeling.detector.pointnet2.pointnet2_utils
...
class ProposalModule(nn.Module):
    ...
    def forward(self, xyz, features, end_points):
        ...
        if self.sampling == 'vote_fps':
            ...
            sample_inds = model.modeling.detector.pointnet2.pointnet2_utils.furthest_point_sample(end_points['seed_xyz'], self.num_proposal)
