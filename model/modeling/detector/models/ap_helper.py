...
from model.modeling.detector.utils.eval_det import eval_det_cls, eval_det_multiprocessing
from model.modeling.detector.utils.eval_det import get_iou_obb
from model.modeling.detector.utils.nms import nms_2d_faster, nms_3d_faster, nms_3d_faster_samecls
from model.modeling.detector.utils.box_util import get_3d_box_new, get_3d_box_old
...
def parse_predictions(end_points, config_dict):
    ...
    for i in range(bsize):
        for j in range(num_proposal):
            ...
            corners_3d_upright_camera = get_3d_box_old(box_size, heading_angle, pred_center_upright_camera[i, j, :])
...
def parse_groundtruths(end_points, config_dict):
    ...
    for i in range(bsize):
        for j in range(K2):
            ...
            corners_3d_upright_camera = get_3d_box_old(box_size, heading_angle, gt_center_upright_camera[i, j, :])
