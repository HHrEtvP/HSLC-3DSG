...
def box3d_iou_depth(corners1, corners2):
    # corner points are in counter clockwise order
...
def get_3d_box_old(box_size, heading_angle, center):
    ''' box_size is array(l,w,h), heading_angle is radius clockwise from pos x axis, center is xyz of box center
        ...
        Similar to my_utils/compute_orientation_3d
        用于在upright_camera坐标系下计算坐标
    '''
...
def get_3d_box_new(box_size, heading_angle, center):
    """
    用于在upright_depth坐标系下计算边界点坐标
    :param box_size:
    :param heading_angle:
    :param center:
    :return:
