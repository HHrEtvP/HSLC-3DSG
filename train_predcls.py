...
parser.add_argument('--dataset_path', default=None, help='3DSSG dataset path')
parser.add_argument('--glove_path', default=None, help='GLoVe embeddings path')
...
def train_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TRAIN_DATALOADER):
        ...
        loss = loss_proxi_relation + loss_support_relation
