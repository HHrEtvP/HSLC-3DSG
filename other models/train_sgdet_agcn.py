...
# from model.modeling.roi_head.relation_head.metric_processor import RKProcessor, REL_parse_gt, REL_parse_output

BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # "...\Experiment-PredCLS"
ROOT_DIR = BASE_DIR
sys.path.append(os.path.join(ROOT_DIR, 'model'))  # "...\Experiment-PredCLS\model"
...
cfg.merge_from_file(os.path.join(ROOT_DIR, "e2e_relation_sgdet_votenet_agcn.yaml"))
cfg.freeze()
...
def train_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TRAIN_DATALOADER):
        ...
        loss_relation, loss_refine, rel_cls_acc, obj_cls_acc = loss_processor(end_dict['proposals'],
                                                                              ...
                                                                              has_obj=True,
                                                                              has_rel=True)
        loss = loss_relation + loss_refine
